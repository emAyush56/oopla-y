...
function Privacy() {
  return (
    <div className="mx-auto">
      <PagesHeader />
      <div className="mx-auto max-w-2xl px-6 pb-20 pt-10 lg:px-4 lg:py-14">
        <section className="header">
          <div className="last_updated font-medium text-theme-purple">
            Last updated August 23, 2023
          </div>
          <h1 className="title mt-4 text-4xl font-bold">Privacy Policy</h1>
        </section>
        <section className="content mt-12 text-gray-600">
          <div className="paragraph">
            <p>
              Oopla built the Oopla app as a Freemium app. This SERVICE is
              provided by Oopla at no cost and is intended for use as is. This
              ...
              meanings as in our Terms and Conditions, which are accessible at
              Oopla unless otherwise defined in this Privacy Policy.
            </p>
          </div>

          <div className="heading-paragraph mt-6 space-y-4">
            ...
            <p>
              ...
              information, including but not limited to user prompts, gmail,
              name, location, dob. The information that we request will be
          ...
          <div className="heading-paragraph mt-6 space-y-4">
            <h2 className="text-xl font-medium">Log Data</h2>
            <p>
          ...
          <div className="heading-paragraph mt-6 space-y-4">
            <h2 className="text-xl font-medium">Links to Other Sites</h2>
            <p>
          ...
          <div className="heading-paragraph mt-6 space-y-4">
            ...
            <p>This policy is effective as of 2023-04-03</p>
          </div>
          ...
          <div className="heading-paragraph mt-6 space-y-4">
            ...
            <p>
              ...
              <a className="cursor-pointer text-theme-purple-500 underline decoration-dashed decoration-1 transition-all">
                Oopla.keyboard@gmail.com
              </a>
              .
            </p>
            <p>
